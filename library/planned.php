...
$lines = array(
    array(
        'Cobar - Wilcannia',
        'Cobar to Wilcannia Railway Act 1902 No 85',
...
considered desirable by the Constructing Authority.',
        '&pound;403,288',
        'Although this line was not constructed, the Baradine-Gwabegar
...
Constructing Authority.',
    ...
    array(
        'Casino - Bonalbo',
        'Casino to Bonalbo Railway Act 1928 No 16',
...
may be considered desirable by the Constructing Authority.',
        '&pound;943,647',
        'Construction was started but only as far as creating some of the earthworks',
    ),
    array(
        'Glen Innes - Inverell',
...
Constructing Authority.',
        '&pound;1,353,789',
        'The section Sandy Hollow - Gulgong was started, abandoned, and later completed in the 1980s.'
    ),
    array(
        'Thirlmere - Burragorang',
        'Thirlmere to Burragorang Railway Act 1951 No 28',
...
{
    list($line, $act, $text, $cost, $note) = $line;

    $t->setCurrentBlock("LINE");

    $t->setVariable("NAME", $line);
    $t->setVariable("ACT", $act);
