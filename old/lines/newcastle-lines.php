...
print_region('1', "NSW", "GOODS", "Freight Lines");
print_region('2', "NSW", "SMR", "South Maitland Railway");
print_region('3', "NSW", "COAL", "Colliery Lines");

$t->setCurrentBlock("MAIN");
$t->setVariable("TITLE", "Newcastle Lines");
$t->parseCurrentBlock();
