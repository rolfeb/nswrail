...
<div id="dialog-form" title="Upload a photograph">
    ...
    <form action="/c/photos/submit.php" method="post" enctype="multipart/form-data">
    <fieldset>
        <label for="state">State</label>
        <select name="state" id="state" class="ui-widget-content ui-corner-all" >
        <option></option>
        ...
        <textarea cols="60" rows="5" name="description" id="description" class="text ui-widget-content ui-corner-all" ></textarea>
